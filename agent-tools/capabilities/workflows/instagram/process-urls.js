#!/usr/bin/env node
/**
 * @workflow instagram.process-urls
 * @when Process list of Instagram post URLs and extract full content data
 * @complexity low
 * @category instagram
 *
 ...
 *
 * @example
 * node process-urls.js --param value
 */
...
const logger = createLogger({ toolName: 'instagram.process-urls' });
