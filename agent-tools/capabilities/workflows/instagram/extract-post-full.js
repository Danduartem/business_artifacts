...
/**
 * @workflow instagram.extract-post-full
 * @description Extract complete Instagram post data including caption, format, screenshot, and media
 * @category instagram
 *
 * @input url string - Instagram post URL (required)
 * @input profile boolean - Use Chrome profile (optional)
 * @input screenshot boolean - Take screenshot (default: true)
 * @input download-media boolean - Download media files (default: false)
 *
 * @output postId string - Post ID from URL
 * @output url string - Post URL
 * @output creator string - Username
 * @output datePosted string - ISO date when posted
 * @output caption string - Full caption text
 * @output format string - Reel, Carousel, Single Image, Video
 * @output isReel boolean - True if format is Reel
 * @output screenshotPath string - Path to screenshot file
 * @output mediaUrls array - Array of media URLs
 * @output videoTranscription string - Whisper transcription if video
 *
 * @example
 * node instagram/extract-post-full.js --url "https://www.instagram.com/p/ABC123/" --profile
 */
