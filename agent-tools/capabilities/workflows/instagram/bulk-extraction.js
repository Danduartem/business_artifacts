 ...
 * @when Extract all Instagram posts from specified profiles within a date range, download media, transcribe videos, and export to structured format
 * @complexity high
 * @category instagram
 *
 * @composes instagram.extract-profile, media.download-and-transcribe, content.format-export
 *
 * @flag profiles
 * @flag startDate
 * @flag endDate
 ...
 *
 * @example
 * node bulk-extraction.js --param value
 */
...
const logger = createLogger({
  toolName: 'instagram.bulk-extraction'
});

const state = createStateManager({
  namespace: 'workflow-bulk-content-extraction'
});
