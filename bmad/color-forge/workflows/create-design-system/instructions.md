...
<critical>You MUST have already loaded and processed: {project-root}/bmad/color-forge/workflows/create-design-system/workflow.yaml</critical>
...
"Welcome to the Color Forge Design System Pipeline!
...
**Color Palette:** (path or "skip")</ask>
    ...
    <check if="user chooses 2">
      ...
      <action>Create files in {project-root}/bmad/color-forge/briefs/</action>
    </check>
...
4. **Return to menu** - Go back to Color Forge menu
